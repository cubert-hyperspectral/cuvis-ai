...
Profiling can also be controlled remotely via gRPC. See the [gRPC API Reference](https://cubert-hyperspectral.github.io/cuvis-ai/0.13.4/deployment/api/training-inference/#profiling) for details on:
