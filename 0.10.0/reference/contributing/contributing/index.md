...
1. Follow the [Plugin Development Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.0/reference/plugin-development/guide/index.md) to create your plugin
1. Implement nodes inheriting from `cuvis_ai_core.node.Node`
1. Test with cuvis-ai pipelines using local plugin loading
1. Publish to GitHub and submit to the central registry (see [Plugin Contribution Workflow](#plugin-contribution-workflow) below)
...
1. Follow the [Add Built-in Node Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.0/reference/contributing/add-builtin-node/index.md)
1. Submit a pull request with comprehensive tests
1. Undergo code review and integration testing
...
Follow the comprehensive [Plugin Development Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.0/reference/plugin-development/guide/index.md) to create your plugin from scratch.
...
registry.register_plugin('plugins.yaml')
...
### Step 4: Add a Plugin Manifest

Register your plugin with cuvis-ai by adding a dedicated manifest file so users can discover and load it.
...
Edit `docs/reference/plugin-development/overview.md` under the "Community Plugins" section:
...
We use **Google-style docstrings**. See the [Docstrings Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.0/reference/contributing/docstrings/index.md) for detailed formatting requirements.
