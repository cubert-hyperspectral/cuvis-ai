...
See [Two-Phase Training](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.0/concepts/training/index.md) for details.
...
For details, see [Profiling & Performance](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.0/workflows/profiling/index.md).
...
| Monitor performance | `pipeline.set_profiling(enabled=True)` -- see [Profiling](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.0/workflows/profiling/index.md) |
