...
Obtain a suitable build of **Cuvis SDK 3.5.0** for your OS from the [Cuvis SDK download page](https://cubert-hyperspectral.github.io/cuvis.sdk/installation/), then verify:
...
- **[Quickstart](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/get-started/quickstart/index.md)**
- **[Configuration](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/reference/configuration/index.md)**
- **[Use Cases](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/tutorials/index.md)**
