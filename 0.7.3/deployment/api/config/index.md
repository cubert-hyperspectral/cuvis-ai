...
- [Hydra Basics](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/reference/configuration/hydra-basics/index.md)
- [TrainRun Schema](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/reference/configuration/trainrun-schema/index.md)
...
- [Train](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/deployment/api/training-inference/#train) - Execute training after config applied
