...
| `cuvis_ai_version` | `str`       | Version of cuvis-ai-schemas used   |
...
| Name          | Type       | Description      | Default                                                               |
| ------------- | ---------- | ---------------- | --------------------------------------------------------------------- |
| `other`       | \`PortSpec | list[PortSpec]\` | Target port spec. If a list, it's a variadic port - extract the spec. |
...
- **[Node Catalog](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/catalogs/nodes/index.md)**: Node implementations with port specifications
- **[Pipeline API](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/reference/python-api/pipeline/index.md)**: Pipeline and connection management
- **[Core Concepts](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/concepts/index.md)**: Understand the architecture
- **[Quickstart](https://cubert-hyperspectral.github.io/cuvis-ai/0.7.3/get-started/quickstart/index.md)**: Practical port usage examples
