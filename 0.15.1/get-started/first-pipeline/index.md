...
If you have not installed cuvis-ai yet, follow the [Installation Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.1/get-started/installation/index.md) first.
...
This drops `.cu3s` files under `data/XMR_Demo_Blood_Perfusion/`. Other demo datasets live in the [datasets catalog](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.1/catalogs/datasets/index.md).
...
Your browser does not support embedded video. The clip lives at [img/ndvi-projection.mp4](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.1/get-started/img/ndvi-projection.mp4). \](../img/ndvi-projection.mp4)

## 4. Where to go next

- **[Blood Perfusion Tutorial](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.1/tutorials/statistical/blood-perfusion/index.md)** — the spectral theory, plus an extension that adds a qualitative SpO₂ proxy.
...
- **[Concepts](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.1/concepts/index.md)** — the mental model: nodes, ports, pipelines, training.
- **[Workflows → Build Pipeline (YAML)](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.1/workflows/build-pipeline-yaml/index.md)** — author a YAML pipeline from scratch.
- **[Workflows → Restore Pipeline](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.1/workflows/restore-pipeline/index.md)** — full reference for the `restore-pipeline` CLI.
- **[Tutorials](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.1/tutorials/index.md)** — the rest of the gallery: RX Anomaly, Channel Selection, Deep SVDD, AdaCLIP.
