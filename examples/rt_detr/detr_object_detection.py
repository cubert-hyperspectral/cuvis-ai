...
def main(
    ...
    pipeline.connect(
        ...
        (false_rgb.rgb_image, detection_node.rgb_image),
        (detection_node.raw_logits, postprocess_node.raw_logits),
        (detection_node.raw_boxes, postprocess_node.raw_boxes),
        (detection_node.orig_hw, postprocess_node.orig_hw),
        (postprocess_node.bboxes, category_filter.bboxes),
        (postprocess_node.category_ids, category_filter.category_ids),
        (postprocess_node.confidences, category_filter.confidences),
        (cu3s_data.outputs.frame_id, json_sink.frame_id),
        (category_filter.bboxes, json_sink.bboxes),
        (category_filter.category_ids, json_sink.category_ids),
        (category_filter.confidences, json_sink.confidences),
        (detection_node.orig_hw, json_sink.orig_hw),
        (false_rgb.rgb_image, overlay_node.rgb_image),
        (category_filter.bboxes, overlay_node.bboxes),
        (category_filter.category_ids, overlay_node.category_ids),
        (category_filter.confidences, overlay_node.confidences),
