"""Run SAM3 prompt-free segment-everything via the gRPC Inference API.
...
DEFAULT_CU3S_PIPELINE = "configs/pipeline/sam3/sam3_segment_everything.yaml"
DEFAULT_VIDEO_PIPELINE = "configs/pipeline/sam3/sam3_segment_everything_video.yaml"
...
def run_client(
    *,
    ...
    try:
        ...
        desc = "SAM3 segment everything gRPC"
        for batch in tqdm(loader, total=total_frames, desc=desc, unit="frame"):
...
@click.option(
    ...
    default=Path("outputs/sam3_grpc_segment_everything_results.json"),
    show_default=True,
