...
Override Hydra params like data_root, train_ids, test_ids, or model_name, e.g.:
    ...
    uv run python examples/adaclip/statistical_supervised_windowed_false_rgb.py \\
...
DEFAULT_EXPERIMENT_NAME = "statistical_adaclip_supervised_windowed_false_rgb"
...
def main(cfg: DictConfig) -> None:
    ...
    logger.info("=== AdaCLIP supervised windowed false-RGB example ===")
