...
Override Hydra params like data_root, train_ids, test_ids, or model_name, e.g.:
    ...
    uv run python examples/adaclip/statistical_cir_false_color.py \\
...
DEFAULT_EXPERIMENT_NAME = "statistical_adaclip_cir_false_color"
...
def main(cfg: DictConfig) -> None:
    ...
    logger.info("=== AdaCLIP CIR false-color example ===")
