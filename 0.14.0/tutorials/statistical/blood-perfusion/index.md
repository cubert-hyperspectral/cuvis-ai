...
- [Dataset on HuggingFace](https://huggingface.co/datasets/cubert-gmbh/XMR_Demo_Blood_Perfusion) — also surfaced in the [datasets catalog](https://cubert-hyperspectral.github.io/cuvis-ai/0.14.0/catalogs/datasets/XMR_Demo_Blood_Perfusion/index.md)
