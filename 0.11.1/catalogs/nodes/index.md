...
Every node available in cuvis-ai pipelines, in one place. Built-in nodes ship with the `cuvis_ai` package; plugin nodes and data modules come from separately-installable plugin manifests — see [Plugin Development](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.1/reference/plugin-development/overview/index.md).
...
`AdaCLIPFocalDiceLoss`cuvis_ai_adaclip.node.losseslossdifftorchtrainadaclip[↗](https://github.com/cubert-hyperspectral/cuvis-ai-adaclip "Open plugin repo")Combined Focal + Dice loss node for AdaCLIP training.

Combined Focal + Dice loss node for AdaCLIP training.

Inputs

| Port                        | Dtype     | Shape              | Description                                                  |
| --------------------------- | --------- | ------------------ | ------------------------------------------------------------ |
| `predictions`               | `float32` | `[-1, -1, -1, 1]`  | Aggregated anomaly scores [B, H, W, 1] for the fallback path |
...
[View plugin repo (v0.2.0)](https://github.com/cubert-hyperspectral/cuvis-ai-adaclip/tree/v0.2.0)
...
[View plugin repo (v0.4.1)](https://github.com/cubert-hyperspectral/cuvis-ai-dinomaly/tree/v0.4.1)
...
[View plugin repo (v0.2.2)](https://github.com/cubert-hyperspectral/cuvis-ai-inspecscrap/tree/v0.2.2)
...
[View plugin repo (v0.2.1)](https://github.com/cubert-hyperspectral/cuvis-ai-deepeiou/tree/v0.2.1)
...
[View plugin repo (v0.2.0)](https://github.com/cubert-hyperspectral/cuvis-ai-rtsam2/tree/v0.2.0)
...
[View plugin repo (v0.2.1)](https://github.com/cubert-hyperspectral/cuvis-ai-sam3/tree/v0.2.1)
...
[View plugin repo (v0.4.0)](https://github.com/cubert-hyperspectral/cuvis-ai-dataloader/tree/v0.4.0)
...
[View plugin repo (v0.3.3)](https://github.com/cubert-hyperspectral/cuvis-ai-augment/tree/v0.3.3)
