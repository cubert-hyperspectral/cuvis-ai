...
A selector split assigns samples to stages by identity. A `universe_csv` (a `universe.csv`) supplies an explicit sample universe for formats that cannot enumerate from disk (npz). See [Data Splits](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.1/concepts/data-splits/index.md) for the full model (universe, selectors, baking).
...
- [Configuration Basics](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.1/reference/configuration/index.md)
- [Config Groups](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.1/reference/configuration/config-groups/index.md)
- [Data Splits](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.1/concepts/data-splits/index.md)
