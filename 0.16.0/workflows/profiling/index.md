...
Profiling can also be controlled remotely via gRPC. See the [gRPC API Reference](https://cubert-hyperspectral.github.io/cuvis-ai/0.16.0/deployment/api/training-inference/#profiling) for details on:
