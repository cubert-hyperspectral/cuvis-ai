...
- Basic understanding of [Pipeline Lifecycle](https://cubert-hyperspectral.github.io/cuvis-ai/0.12.0/concepts/pipeline/index.md)
- Familiarity with [TrainRun Schema](https://cubert-hyperspectral.github.io/cuvis-ai/0.12.0/reference/configuration/trainrun-schema/index.md)
...
For complete plugin development documentation, see [Plugin Development Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.12.0/reference/plugin-development/guide/index.md).
...
- [Build Pipelines in Python](https://cubert-hyperspectral.github.io/cuvis-ai/0.12.0/workflows/build-pipeline-python/index.md)
- [Build Pipelines in YAML](https://cubert-hyperspectral.github.io/cuvis-ai/0.12.0/workflows/build-pipeline-yaml/index.md)
- [TrainRun Schema Reference](https://cubert-hyperspectral.github.io/cuvis-ai/0.12.0/reference/configuration/trainrun-schema/index.md)
- [Monitoring and Visualization](https://cubert-hyperspectral.github.io/cuvis-ai/0.12.0/workflows/monitoring/index.md)
