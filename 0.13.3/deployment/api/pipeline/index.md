...
- After loading, pipeline is ready for training or inference **See Also:**
...
1. **Weights file (.pt)** - PyTorch checkpoint with trained weights
1. **Metadata** - Optional name, description, tags, author
...
- [Restore Pipeline Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.13.3/workflows/restore-pipeline/index.md)
