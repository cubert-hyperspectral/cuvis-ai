...
- **TensorBoard Integration**: Centralized logging with the [Visualization Nodes](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.0/catalogs/nodes/#category=visualizer) (TensorBoardMonitorNode and siblings)
...
- **Node Catalog**:
- [Visualization Nodes](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.0/catalogs/nodes/#category=visualizer) - TensorBoardMonitorNode and visual monitoring
- [Metrics Nodes](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.0/catalogs/nodes/#category=metric) - AnomalyDetectionMetrics, ScoreStatistics, etc.
- **Guides**:
- [Build Pipelines in Python](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.0/workflows/build-pipeline-python/index.md) - Pipeline construction basics
- [Configuration Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.0/reference/configuration/index.md) - TrainRun configuration
