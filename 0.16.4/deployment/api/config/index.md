...
- [Hydra Basics](https://docs.cuvis.ai/latest/reference/configuration/hydra-basics/index.md)
- [TrainRun Schema](https://docs.cuvis.ai/latest/reference/configuration/trainrun-schema/index.md)
...
- [Train](https://docs.cuvis.ai/latest/deployment/api/training-inference/#train) - Execute training after config applied
