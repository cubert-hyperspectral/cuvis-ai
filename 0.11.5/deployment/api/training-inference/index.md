...
- [Sequence Diagrams](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/deployment/sequence-diagrams/#2-two-phase-training-workflow)
...
- [InputBatch Data Type](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/deployment/api/types-errors/#inputbatch)
- [GetPipelineInputs](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/deployment/api/types-errors/#getpipelineinputs) - Query required inputs
- [GetPipelineOutputs](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/deployment/api/types-errors/#getpipelineoutputs) - Query available outputs

______________________________________________________________________

## Profiling

Enable runtime profiling and retrieve per-node timing statistics. For a comprehensive guide on profiling workflows, see [Profiling & Performance](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/workflows/profiling/index.md).
...
- [gRPC API Reference](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/deployment/api/session/index.md) - Session, configuration, and pipeline management
- [Types & Errors API](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/deployment/api/types-errors/index.md) - Introspection, error handling, and data types
- [Client Workflows & Error Handling](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/deployment/client-workflows/index.md) - Training, inference, and error handling patterns
- [Sequence Diagrams](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/deployment/sequence-diagrams/index.md) - Visual workflows
