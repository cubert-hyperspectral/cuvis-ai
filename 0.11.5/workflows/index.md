...
If you're new and need step-by-step learning instead, start with [Tutorials](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/tutorials/index.md).

## Build a pipeline

- **[Build Pipeline (Python)](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/workflows/build-pipeline-python/index.md)**
...
- **[Statistical Training](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/workflows/statistical-training/index.md)**

  ______________________________________________________________________

  Fit a pipeline using `StatisticalTrainer` — accumulate background moments, no gradient steps.

- **[Gradient Training](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/workflows/gradient-training/index.md)**
...
- **[Monitoring & Visualization](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/workflows/monitoring/index.md)**

  ______________________________________________________________________

  TensorBoard, metric callbacks, and runtime visualisation of pipeline state.

- **[Profiling](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.5/workflows/profiling/index.md)**
