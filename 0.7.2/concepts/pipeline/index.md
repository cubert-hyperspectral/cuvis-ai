...
See [Two-Phase Training](https://docs.cuvis.ai/0.7.2/concepts/training/index.md) for details.
...
For details, see [Profiling & Performance](https://docs.cuvis.ai/0.7.2/workflows/profiling/index.md).
...
| Monitor performance  | `pipeline.set_profiling(enabled=True)` -- see [Profiling](https://docs.cuvis.ai/0.7.2/workflows/profiling/index.md) |
