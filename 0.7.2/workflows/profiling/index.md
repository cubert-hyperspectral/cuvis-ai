...
Profiling can also be controlled remotely via gRPC. See the [gRPC API Reference](https://docs.cuvis.ai/0.7.2/deployment/api/training-inference/#profiling) for details on:
