...
- Familiarity with [Nodes](https://docs.cuvis.ai/0.7.2/concepts/node/index.md)
...
- [Pipeline Lifecycle](https://docs.cuvis.ai/0.7.2/concepts/pipeline/index.md)
- [Node System](https://docs.cuvis.ai/0.7.2/concepts/node/index.md)
- [RX Statistical Tutorial](https://docs.cuvis.ai/0.7.2/tutorials/statistical/rx-anomaly/index.md)
- [Deep SVDD Tutorial](https://docs.cuvis.ai/0.7.2/tutorials/gradient/deep-svdd/index.md)
