...
- Basic understanding of [Pipeline Lifecycle](https://docs.cuvis.ai/0.7.2/concepts/pipeline/index.md)
- Familiarity with [TrainRun Schema](https://docs.cuvis.ai/0.7.2/reference/configuration/trainrun-schema/index.md)
...
For complete plugin development documentation, see [Plugin Development Guide](https://docs.cuvis.ai/0.7.2/reference/plugin-development/guide/index.md).
...
- [Build Pipelines in Python](https://docs.cuvis.ai/0.7.2/workflows/build-pipeline-python/index.md)
- [Build Pipelines in YAML](https://docs.cuvis.ai/0.7.2/workflows/build-pipeline-yaml/index.md)
- [TrainRun Schema Reference](https://docs.cuvis.ai/0.7.2/reference/configuration/trainrun-schema/index.md)
- [Monitoring and Visualization](https://docs.cuvis.ai/0.7.2/workflows/monitoring/index.md)
