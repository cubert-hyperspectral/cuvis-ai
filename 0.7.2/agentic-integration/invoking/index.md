...
- **Plugin manifest** — manifests follow the [Plugin Development](https://docs.cuvis.ai/0.7.2/reference/plugin-development/overview/index.md) format. `cuvis-ai-pipeline` and `cuvis-ai-inference` honour whatever manifest `cuvis-ai-env` recorded.
...
| Skill doesn't trigger on a prompt             | Keywords didn't match              | Invoke explicitly with `/<skill-name>` or include the trigger keyword from the [skills catalog](https://docs.cuvis.ai/0.7.2/agentic-integration/skills/index.md). |
