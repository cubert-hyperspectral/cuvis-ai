...
- [Hydra Basics](https://docs.cuvis.ai/0.7.2/reference/configuration/hydra-basics/index.md)
...
- [Train](https://docs.cuvis.ai/0.7.2/deployment/api/training-inference/#train) - Execute training after config applied
