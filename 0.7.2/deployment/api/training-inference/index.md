...
- [Sequence Diagrams](https://docs.cuvis.ai/0.7.2/deployment/sequence-diagrams/#2-two-phase-training-workflow)
...
- [InputBatch Data Type](https://docs.cuvis.ai/0.7.2/deployment/api/types-errors/#inputbatch)
- [GetPipelineInputs](https://docs.cuvis.ai/0.7.2/deployment/api/types-errors/#getpipelineinputs) - Query required inputs
- [GetPipelineOutputs](https://docs.cuvis.ai/0.7.2/deployment/api/types-errors/#getpipelineoutputs) - Query available outputs

______________________________________________________________________

## Profiling

Enable runtime profiling and retrieve per-node timing statistics. For a comprehensive guide on profiling workflows, see [Profiling & Performance](https://docs.cuvis.ai/0.7.2/workflows/profiling/index.md).
...
- [gRPC API Reference](https://docs.cuvis.ai/0.7.2/deployment/api/session/index.md) - Session, configuration, and pipeline management
- [Types & Errors API](https://docs.cuvis.ai/0.7.2/deployment/api/types-errors/index.md) - Introspection, error handling, and data types
- [Client Workflows & Error Handling](https://docs.cuvis.ai/0.7.2/deployment/client-workflows/index.md) - Training, inference, and error handling patterns
- [Sequence Diagrams](https://docs.cuvis.ai/0.7.2/deployment/sequence-diagrams/index.md) - Visual workflows
