...
- Understanding of [Node System Deep Dive](https://docs.cuvis.ai/0.7.2/concepts/node/index.md)
...
- Documentation added to [Node Catalog](https://docs.cuvis.ai/0.7.2/catalogs/nodes/index.md)
...
Create entry in [Node Catalog](https://docs.cuvis.ai/0.7.2/catalogs/nodes/index.md):
...
- [Node System Deep Dive](https://docs.cuvis.ai/0.7.2/concepts/node/index.md)
- [Node Catalog](https://docs.cuvis.ai/0.7.2/catalogs/nodes/index.md)
...
- [Contributing Guide](https://docs.cuvis.ai/0.7.2/reference/contributing/contributing/index.md)
