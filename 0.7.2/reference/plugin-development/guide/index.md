...
See [Plugin System Overview](https://docs.cuvis.ai/0.7.2/reference/plugin-development/overview/index.md) for loader behavior and [Plugin Nodes](https://docs.cuvis.ai/0.7.2/catalogs/nodes/index.md) for end-user loading examples.
