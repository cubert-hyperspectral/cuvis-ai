...
Each plugin ships its own `plugins.yaml` manifest; reference the ones you need from your config. The full list of plugin-supplied nodes lives in the [Nodes catalog](https://docs.cuvis.ai/0.7.2/catalogs/nodes/index.md).

## Related Pages

- [Configuration Basics](https://docs.cuvis.ai/0.7.2/reference/configuration/index.md)
