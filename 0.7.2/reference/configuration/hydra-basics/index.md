...
- [Hydra Inheritance & Overrides](https://docs.cuvis.ai/0.7.2/reference/configuration/hydra-inheritance/index.md) — config inheritance, interpolation, overrides
- [Hydra Sweeps & Advanced](https://docs.cuvis.ai/0.7.2/reference/configuration/hydra-sweeps/index.md) — multi-run sweeps, composition patterns
