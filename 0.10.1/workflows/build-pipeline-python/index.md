...
- Familiarity with [Nodes](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.1/concepts/node/index.md)
...
1. **Group related connections with comments** - Organize connection tuples by purpose (processing flow, metrics flow, visualization flow)
1. **Store nodes in descriptive variables** - Use `data_node`, `normalizer`, `rx` instead of generic names
1. **Validate early** - Call `pipeline.verify()` before training to catch connection errors
1. **Leverage port attributes** - Use `node.port_name` for direct port access (e.g., `data_node.outputs.cube`)
1. **Connect in logical order** - Group connections by data flow (processing → metrics → visualization)
1. **Use factory functions** - Create reusable pipeline patterns for common workflows
...
- [Pipeline Lifecycle](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.1/concepts/pipeline/index.md)
- [Node System](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.1/concepts/node/index.md)
- [RX Statistical Tutorial](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.1/tutorials/statistical/rx-anomaly/index.md)
- [Deep SVDD Tutorial](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.1/tutorials/gradient/deep-svdd/index.md)
