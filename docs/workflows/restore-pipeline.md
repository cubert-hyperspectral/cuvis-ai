...
- Basic understanding of [Pipeline Lifecycle](../concepts/pipeline.md)
- Familiarity with [TrainRun Schema](../reference/configuration/trainrun-schema.md)
...
For complete plugin development documentation, see [Plugin Development Guide](../reference/plugin-development/guide.md).
...
- [TrainRun Schema Reference](../reference/configuration/trainrun-schema.md)
- [Monitoring and Visualization](monitoring.md)
