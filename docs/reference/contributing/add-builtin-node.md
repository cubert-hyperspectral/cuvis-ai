...
- Understanding of [Node System Deep Dive](../../concepts/node.md)
...
- [ ] Documentation added to [Node Catalog](../../catalogs/nodes/index.md)
...
Create entry in [Node Catalog](../../catalogs/nodes/index.md):
...
- [Node System Deep Dive](../../concepts/node.md)
- [Node Catalog](../../catalogs/nodes/index.md)
