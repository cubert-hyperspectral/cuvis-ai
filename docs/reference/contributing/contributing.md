...
1. Follow the [Plugin Development Guide](../plugin-development/guide.md) to create your plugin
...
1. Follow the [Add Built-in Node Guide](add-builtin-node.md)
...
Follow the comprehensive [Plugin Development Guide](../plugin-development/guide.md) to create your plugin from scratch.
