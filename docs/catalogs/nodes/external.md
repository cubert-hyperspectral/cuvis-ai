...
Externally contributed nodes loaded through the [plugin system](../../reference/plugin-development/overview.md).
Each plugin ships its own Git repository and is loaded at runtime via a YAML manifest
(see [Plugin System Overview](../../reference/plugin-development/overview.md)).
...
**Use Case:** [AdaCLIP Workflow](../../tutorials/gradient/adaclip.md)
...
See [Plugin System Overview](../../reference/plugin-development/overview.md) for architecture details and
[Plugin Development Guide](../../reference/plugin-development/guide.md) for creating new plugins.
