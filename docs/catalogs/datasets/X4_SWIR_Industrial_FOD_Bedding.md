...
<p align="center">
  ...
  <a href="https://huggingface.co/datasets/cubert-gmbh/XMR_Industrial_Foreign_Object_Detection_Lentils"><img src="https://img.shields.io/badge/Sibling-Lentils%20dataset-ffd21e?logo=huggingface&logoColor=000" alt="Sibling lentils dataset"/></a>
</p>
...
|:---:|:---:|:---:|
| ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/small_fragments_9_frame_33_ok_nok_rdx_rwx_rgb.png) | ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/small_fragments_9_frame_33_ok_nok_rdx_rwx_rgb_annotated.png) | ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/small_fragments_9_frame_33_ok_nok_rdx_rwx_swir.png) |
...
| VIS-RGB | VIS-RGB + annotations | SWIR pseudo-RGB |
|:---:|:---:|:---:|
| ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/water_04_frame_9_nok_ok_rdx_rwx_rgb.png) | ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/water_04_frame_9_nok_ok_rdx_rwx_rgb_annotated.png) | ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/water_04_frame_9_nok_ok_rdx_rwx_swir.png) |
...
| VIS-RGB | VIS-RGB + annotations | SWIR pseudo-RGB |
|:---:|:---:|:---:|
| ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/multi_object_frame_121_nok_nok_rdx_rwx_rgb.png) | ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/multi_object_frame_121_nok_nok_rdx_rwx_rgb_annotated.png) | ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/multi_object_frame_121_nok_nok_rdx_rwx_swir.png) |
...
|:---:|:---:|
| ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/normal_rd4_rw8_36_frame_29_ok_ok_rd4_rw8_rgb.png) | ![](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/assets/examples/normal_rd4_rw8_36_frame_29_ok_ok_rd4_rw8_swir.png) |
...
- **Native (this repo's COCO + masks): 2400 × 4900.** This is what `cuvis`
  ...
  polygons (`annotations_canonical/`, `data/<split>/<stem>.json`) and the raw
...
Released under the **Apache License 2.0** — see [`LICENSE`](https://huggingface.co/datasets/cubert-gmbh/X4_SWIR_Industrial_Foreign_Object_Detection_Bedding/resolve/main/LICENSE). Matches the
