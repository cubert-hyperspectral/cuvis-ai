...
![Cuvis.AI pipeline — SAM3 mask propagation over hyperspectral video](https://huggingface.co/datasets/cubert-gmbh/XMR_Demo_Object_Tracking/resolve/main/assets/sam3_pipeline.png)

1. **CU3SDataNode** — reads the `.cu3s` hyperspectral cube (61 bands / pixel per frame).
2. **CIETristimulusFalseRGBSelector** — projects the spectrum to a 3-channel false-RGB frame.
