...
- [InputBatch Data Type](types-errors.md#inputbatch)
- [GetPipelineInputs](types-errors.md#getpipelineinputs) - Query required inputs
- [GetPipelineOutputs](types-errors.md#getpipelineoutputs) - Query available outputs

---

## Profiling

Enable runtime profiling and retrieve per-node timing statistics. For a comprehensive guide on profiling workflows, see [Profiling & Performance](../../workflows/profiling.md).
...
- [gRPC API Reference](session.md) - Session, configuration, and pipeline management
- [Types & Errors API](types-errors.md) - Introspection, error handling, and data types
