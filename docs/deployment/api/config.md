...
- [Hydra Basics](../../reference/configuration/hydra-basics.md)
- [TrainRun Schema](../../reference/configuration/trainrun-schema.md)
...
- [Train](training-inference.md#train) - Execute training after config applied
