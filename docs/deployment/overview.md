...
See [Hydra Composition Patterns](../reference/configuration/hydra-basics.md) for details.
...
See the [Deployment Guide](grpc-deployment.md) for complete instructions.
...
- [gRPC Workflow Tutorial](grpc-workflow.md) - Hands-on tutorial with complete examples

### Configuration

- [TrainRun Schema](../reference/configuration/trainrun-schema.md) - Complete trainrun configuration reference
- [Hydra Composition](../reference/configuration/hydra-basics.md) - Config composition patterns and overrides

### Deployment

- [Deployment Guide](grpc-deployment.md) - Docker, Kubernetes, and production patterns
