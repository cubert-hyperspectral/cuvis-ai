...
This tutorial walks through building an end-to-end RX pipeline in cuvis.AI — loading cu3s data, fitting the detector with [statistical training](https://cubert-hyperspectral.github.io/cuvis-ai/0.13.8/concepts/training/index.md), and rendering an anomaly heatmap.
...
- How [statistical nodes](https://cubert-hyperspectral.github.io/cuvis-ai/0.13.8/concepts/training/index.md) accumulate background statistics during initialization.
