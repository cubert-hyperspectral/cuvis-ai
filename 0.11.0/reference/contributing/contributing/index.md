...
1. Follow the [Plugin Development Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.0/reference/plugin-development/guide/index.md) to create your plugin
...
1. Follow the [Add Built-in Node Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.0/reference/contributing/add-builtin-node/index.md)
...
Follow the comprehensive [Plugin Development Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.0/reference/plugin-development/guide/index.md) to create your plugin from scratch.
...
We use **Google-style docstrings**. See the [Docstrings Guide](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.0/reference/contributing/docstrings/index.md) for detailed formatting requirements.
