...
- [Hydra Basics](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.0/reference/configuration/hydra-basics/index.md)
...
1. Sets training parameters (optimizer, scheduler, trainer)
...
- [Train](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.0/deployment/api/training-inference/#train) - Execute training after config applied
