...
Profiling can also be controlled remotely via gRPC. See the [gRPC API Reference](https://docs.cuvis.ai/latest/deployment/api/training-inference/#profiling) for details on:
