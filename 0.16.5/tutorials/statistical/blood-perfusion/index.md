...
The pipeline runs on the `XMR_Demo_Blood_Perfusion` dataset and renders a false-colour perfusion video from the normalised-difference index.
...
- [`cuvis_ai/configs/pipeline/medical/blood_perfusion/ndvi.yaml`](https://github.com/cubert-hyperspectral/cuvis-ai/blob/main/cuvis_ai/configs/pipeline/medical/blood_perfusion/ndvi.yaml) — packaged pipeline, run with `restore-pipeline` as shown in [Your First Pipeline](https://docs.cuvis.ai/latest/get-started/first-pipeline/index.md)
- [Dataset on HuggingFace](https://huggingface.co/datasets/cubert-gmbh/XMR_Demo_Blood_Perfusion) — also surfaced in the [datasets catalog](https://docs.cuvis.ai/latest/catalogs/datasets/XMR_Demo_Blood_Perfusion/index.md)
