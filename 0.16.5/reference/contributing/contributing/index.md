...
1. Follow the [Plugin Development Guide](https://docs.cuvis.ai/latest/reference/plugin-development/guide/index.md) to create your plugin
...
1. Follow the [Add Built-in Node Guide](https://docs.cuvis.ai/latest/reference/contributing/add-builtin-node/index.md)
...
Follow the comprehensive [Plugin Development Guide](https://docs.cuvis.ai/latest/reference/plugin-development/guide/index.md) to create your plugin from scratch.
...
We use **Google-style docstrings**. See the [Docstrings Guide](https://docs.cuvis.ai/latest/reference/contributing/docstrings/index.md) for detailed formatting requirements.
