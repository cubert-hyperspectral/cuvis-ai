...
- **[About Skills](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/agentic-integration/overview/index.md)**

  ______________________________________________________________________

  What skills are, how they hand off to one another, and how `cuvis-ai-env` underpins the rest.

- **[Available Skills](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/agentic-integration/skills/index.md)**

  ______________________________________________________________________

  Catalog of the eight skills: triggers, deliverables, and cross-references.

- **[Invoking Skills](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/agentic-integration/invoking/index.md)**
