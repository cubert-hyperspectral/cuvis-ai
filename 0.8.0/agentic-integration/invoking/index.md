...
- **Plugin manifest** — manifests follow the [Plugin Development](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/reference/plugin-development/overview/index.md) format. `cuvis-ai-pipeline` and `cuvis-ai-inference` honour whatever manifest `cuvis-ai-env` recorded.
...
| Skill doesn't trigger on a prompt             | Keywords didn't match              | Invoke explicitly with `/<skill-name>` or include the trigger keyword from the [skills catalog](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/agentic-integration/skills/index.md). |
