...
- Familiarity with [Nodes](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/concepts/node/index.md)
...
1. **Validate early** - Call `pipeline.validate()` before training to catch connection errors
...
- [Pipeline Lifecycle](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/concepts/pipeline/index.md)
- [Node System](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/concepts/node/index.md)
- [RX Statistical Tutorial](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/tutorials/statistical/rx-anomaly/index.md)
- [Deep SVDD Tutorial](https://cubert-hyperspectral.github.io/cuvis-ai/0.8.0/tutorials/gradient/deep-svdd/index.md)
