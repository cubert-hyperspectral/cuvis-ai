...
Each plugin ships its own `plugins.yaml` manifest; reference the ones you need from your config. The full list of plugin-supplied nodes lives in the [Nodes catalog](https://cubert-hyperspectral.github.io/cuvis-ai/0.9.0/catalogs/nodes/index.md).

## Related Pages

- [Configuration Basics](https://cubert-hyperspectral.github.io/cuvis-ai/0.9.0/reference/configuration/index.md)
