...
Deep Support Vector Data Description (Deep SVDD) learns a compact representation of "normal" data, then flags anything that lands far from the centre at inference time. It's the gradient-trained sibling of [RX anomaly detection](https://cubert-hyperspectral.github.io/cuvis-ai/0.9.0/tutorials/statistical/rx-anomaly/index.md) — slower to train, but able to capture non-Gaussian backgrounds.
...
- How the [gradient training stage](https://cubert-hyperspectral.github.io/cuvis-ai/0.9.0/concepts/training/index.md) consumes a statistically-initialised pipeline.
