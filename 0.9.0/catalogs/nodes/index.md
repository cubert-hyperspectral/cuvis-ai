...
Every node available in cuvis-ai pipelines, in one place. Built-in nodes ship with the `cuvis_ai` package; plugin nodes come from separately-installable manifests — see [Plugin Development](https://cubert-hyperspectral.github.io/cuvis-ai/0.9.0/reference/plugin-development/overview/index.md).
