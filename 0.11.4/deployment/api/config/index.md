...
- [Hydra Basics](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.4/reference/configuration/hydra-basics/index.md)
...
1. Builds pipeline from pipeline config
1. Initializes data loader from data config
1. Sets training parameters (optimizer, scheduler, and trainer settings)
1. Prepares session for training or inference
...
- [Train](https://cubert-hyperspectral.github.io/cuvis-ai/0.11.4/deployment/api/training-inference/#train) - Execute training after config applied
