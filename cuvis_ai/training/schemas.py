...
TODO: Migrate to ``cuvis-ai-schemas`` — these classes belong in the schemas
package, not in ``cuvis-ai``.  Temporary workaround until ``cuvis-ai-schemas``
DataConfig is extended upstream to support ``splits_csv``.  See:
