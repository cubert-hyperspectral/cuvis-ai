...
### [@package](https://github.com/package "GitHub User: package") *global*
...
### [@package](https://github.com/package "GitHub User: package") *group*
...
- [Hydra Inheritance & Overrides](https://cubert-hyperspectral.github.io/cuvis-ai/0.13.2/reference/configuration/hydra-inheritance/index.md) — config inheritance, interpolation, overrides
- [Hydra Sweeps & Advanced](https://cubert-hyperspectral.github.io/cuvis-ai/0.13.2/reference/configuration/hydra-sweeps/index.md) — multi-run sweeps, composition patterns
