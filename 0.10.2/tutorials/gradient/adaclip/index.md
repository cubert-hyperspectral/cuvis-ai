...
- [Dataset on HuggingFace](https://huggingface.co/datasets/cubert-gmbh/XMR_Demo_Industrial_Foreign_Object_Detection_Lentils) — also surfaced in the [datasets catalog](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.2/catalogs/datasets/XMR_Demo_Industrial_FOD_Lentils/index.md)

## What you'll learn

- How [external plugin nodes](https://cubert-hyperspectral.github.io/cuvis-ai/0.10.2/catalogs/nodes/index.md) integrate with cuvis-ai pipelines.
