...
- Understanding of [Node System Deep Dive](https://docs.cuvis.ai/latest/concepts/node/index.md)
...
- Documentation added to [Node Catalog](https://docs.cuvis.ai/latest/catalogs/nodes/index.md)
...
Create entry in [Node Catalog](https://docs.cuvis.ai/latest/catalogs/nodes/index.md):
...
- [Node System Deep Dive](https://docs.cuvis.ai/latest/concepts/node/index.md)
- [Node Catalog](https://docs.cuvis.ai/latest/catalogs/nodes/index.md)
