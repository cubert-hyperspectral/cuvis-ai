...
A selector split assigns samples to stages by identity. A `universe_csv` (a `universe.csv`) supplies an explicit sample universe; `cu3s_multi` and `npz_multi` both read one (only `tiff_paired` enumerates from disk). See [Data Splits](https://docs.cuvis.ai/latest/concepts/data-splits/index.md) for the full model (universe, selectors, baking).
...
- [Configuration Basics](https://docs.cuvis.ai/latest/reference/configuration/index.md)
- [Config Groups](https://docs.cuvis.ai/latest/reference/configuration/config-groups/index.md)
- [Data Splits](https://docs.cuvis.ai/latest/concepts/data-splits/index.md)
