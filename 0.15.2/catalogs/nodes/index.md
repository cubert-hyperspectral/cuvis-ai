...
Every node available in cuvis-ai pipelines, in one place. Built-in nodes ship with the `cuvis_ai` package; plugin nodes and data modules come from separately-installable plugin manifests — see [Plugin Development](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.2/reference/plugin-development/overview/index.md).
...
[View plugin repo (v0.4.0)](https://github.com/cubert-hyperspectral/cuvis-ai-adaclip/tree/v0.4.0)
...
[View plugin repo (v0.7.1)](https://github.com/cubert-hyperspectral/cuvis-ai-dinomaly/tree/v0.7.1)
...
[View plugin repo (v0.4.0)](https://github.com/cubert-hyperspectral/cuvis-ai-rtsam2/tree/v0.4.0)
...
[View plugin repo (v0.4.0)](https://github.com/cubert-hyperspectral/cuvis-ai-sam3/tree/v0.4.0)
