...
A selector split assigns samples to stages by identity. A `universe_csv` (a `universe.csv`) supplies an explicit sample universe; `cu3s_multi` and `npz_multi` both read one (only `tiff_paired` enumerates from disk). See [Data Splits](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.2/concepts/data-splits/index.md) for the full model (universe, selectors, baking).
...
- [Configuration Basics](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.2/reference/configuration/index.md)
- [Config Groups](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.2/reference/configuration/config-groups/index.md)
- [Data Splits](https://cubert-hyperspectral.github.io/cuvis-ai/0.15.2/concepts/data-splits/index.md)
