...
def _prepare_datamodule(data_root: Path, batch_size: int = 1) -> LentilsAnomaly:
    """Download (if needed) and load the Lentils anomaly data module."""
    datamodule = LentilsAnomaly(str(data_root), batch_size=batch_size)
